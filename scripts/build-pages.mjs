...
await writeFile(resolve(output,'release.json'), JSON.stringify({schemaVersion:1,project:'gaokao',release:'20260920-modern-restore',sourceCommit:sha,files:rows},null,2)+'\n');
