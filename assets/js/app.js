...
const GAOKAO_PROMPTS = {
  ...
  guwen: "这是一道古文题，请根据原文和注释,同時基於作者全集,歷代注疏集解,正義,箋注等回答.針對加點字題目務必先找出句子中相同的字再做分析,如有多個相同字選擇虛詞分析或全部都做分析再根據全部題目信息確定應該是哪個字被加了點：",
